    ...
    .then(geojson => {
        L.geoJson(geojson, {
            ...
            style: function(feature) {
                ...
                }else if (feature.properties.id >= 2 && feature.properties.id < 4) {
                    return {
                        color: "#2A5CAA",
                        weight: 0.5,
                        opacity: 0.8,
                ...
                }else if (feature.properties.id >= 4 && feature.properties.id < 6) {
                    return {
                        color: "#F4EE4F",
                        weight: 0.5,
                        opacity: 0.8,
                ...
                }else if (feature.properties.id >= 6 && feature.properties.id < 8) {
                    return {
                        color: "#F08167",
                        weight: 0.5,
                        opacity: 0.8,
